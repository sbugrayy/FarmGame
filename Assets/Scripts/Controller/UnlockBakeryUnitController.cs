...
public class UnlockBakeryUnitController : MonoBehaviour
{
    ...
    public ProductType GetNeededProductType() // pastane bizden hangi ürünleri bekliyor
    {
        return productType;
    }

    public bool StoreProduct() // pastanede depolayacak yer var mı?
    {
    ...
    {
        Vector3 coinPos = Random.insideUnitSphere * 1f;
        Vector3 InstantiatePos = coinTransform.position + coinPos;
